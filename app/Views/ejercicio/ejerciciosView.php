        ...
        <div id="contenidoCards" class="row">
            ...
            ?>
                <div class="col-12 col-md-12 col-lg-6 col-xl-4 ejercicio">
                    <a class="ejercicio-card card" data-bs-toggle="modal" data-bs-target="#ejercicioModal" data-id="<?= $dato["id"] ?>">
                        <img src="<?= baseUrl() ?>/assets/img/exercises/<?= $dato["imagen_1"] ?>" class="card-img-top" alt="<?= $dato["nombre"] ?>">
                        <div class="card-body">
                            <h5 class="card-title"><?= $dato["nombre"] ?></h5>
                            <p class="card-text"><?= $dato["musculo_primario"] ?></p>
                        </div>
                    </a>
                </div>
            <?php

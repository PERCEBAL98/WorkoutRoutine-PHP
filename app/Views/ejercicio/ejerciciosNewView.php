    ...
    <div class="container-fluid">
        <div class="row mb-3 mt-2 justify-content-center">
            <div class="col-12 col-sm-12 col-md-8 bg-white p-4 rounded formulario">
                ...
                ?>
                <form action="<?php echo baseUrl(); ?>/ejercicios/crear" method="post" enctype="multipart/form-data" class="row">
                    <div class="col-12 col-xl-6">
                        ...
                        <div class="mb-2">
                            ...
                            <textarea class="form-control" id="instrucciones" name="instrucciones"><?= set_value('instrucciones'); ?></textarea>
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="mb-2">
                            ...
                            <?php echo form_dropdown('musculo_primario', $optionsMusculoPrimario, set_value('musculo_primario'), 'class="form-control select2" id="musculo_primario"')?>
                        ...
                        <div class="mb-2">
                            ...
                            <?php echo form_dropdown('musculo_secundario', $optionsMusculoSecundario, set_value('musculo_secundario'), 'class="form-control select2" id="musculo_secundario"')?>
                        ...
                        <div class="mb-2">
                            ...
                            <?php echo form_dropdown('nivel', $optionsNivel, set_value('nivel'), 'class="form-control select2" id="nivel"')?>
                        ...
                        <div class="mb-2">
                            ...
                            <?php echo form_dropdown('movimiento', $optionsMovimiento, set_value('movimiento'), 'class="form-control select2" id="movimiento"')?>
                        ...
                        <div class="mb-2">
                            ...
                            <?php echo form_dropdown('categoria', $optionsCategoria, set_value('categoria'), 'class="form-control select2" id="categoria"')?>
                        ...
                        <div class="mb-2">
                            ...
                            <?php echo form_dropdown('mecanica', $optionsMecanica, set_value('mecanica'), 'class="form-control select2" id="mecanica"')?>
                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-12 col-xl-6 mb-2">
                                ...
                                <div>
                                    <img id="imagen-1-preview" src="<?= baseUrl(); ?>/assets/img/imagen_por_defecto.jpg" class="img-fluid border rounded w-100">
                                </div>
                            </div>
                            <div class="col-12 col-xl-6 mb-2">
                                <div>
                                ...
                                <div>
                                    <img id="imagen-2-preview" src="<?= baseUrl(); ?>/assets/img/imagen_por_defecto.jpg" class="img-fluid border rounded w-100">
                                </div>
                            </div>
                        </div>
                    </div>

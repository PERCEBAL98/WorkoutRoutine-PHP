...
return [
    ...
    'max_size' => 'El campo {field} no debe exceder los {param} kilobytes.',
    'is_image' => 'El campo {field} debe contener una imagen válida.',
    'mime_in' => 'El campo {field} debe ser un archivo de tipo: {param}.',
    ...
    'less_than'	=> "El campo {field} debe contener un número menor que %s.",
    'greater_than'=> "El campo {field} debe contener un número mayor que %s.",
];
